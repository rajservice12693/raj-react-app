      ...
      >
        ...
        <Box
          sx={{
            ...
            "@media (max-width: 768px)": {
              fontSize:
                size === "large" ? "28px" : size === "small" ? "14px" : "24px",
            },
            "@media (max-width: 480px)": {
              fontSize:
                size === "large" ? "24px" : size === "small" ? "12px" : "20px",
            },
            background:
              variant === "admin"
        ...
        >
          ...
          <Box
            sx={{
              ...
              bottom: "-2px",
              background:
                "linear-gradient(45deg, #ffc107, #ff8f00, #ffb300, #ffc107)",
          ...
          <Box
            sx={{
              ...
              height: "100%",
              background:
                "linear-gradient(135deg, #ffc107 0%, #ff8f00 50%, #ffb300 100%)",
              clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              boxShadow:
                "0 4px 20px rgba(255, 193, 7, 0.6), inset 0 2px 4px rgba(255, 255, 255, 0.3)",
        ...
        >
          ...
          <Box
            sx={{
              ...
              width: "100%",
              background:
                "linear-gradient(90deg, #ffc107, #ff8f00, #ffb300, #ff8f00, #ffc107)",
              borderRadius: "1px",
