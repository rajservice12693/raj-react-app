  ...
  const dashboardCards = [
    {
      ...
      description:
        "Manage jewellery items, add new pieces, and update existing ones",
    ...
    },
    {
      ...
      description:
        "Organize jewellery by categories and manage category hierarchy",
        ...
        {dashboardData?.categoryWise.map((category, index) => (
          ...
          >
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, ml: 2 }}>
              {Object.entries(category.categoryMaterial).map(
                ([material, count]) => (
                  <Chip
                    key={material}
              ...
              <CardContent sx={{ p: 3, position: "relative" }}>
                ...
                >
                  ...
                  <Chip
                    ...
                    sx={{
                      background:
                        stat.changeType === "positive" ? "#e8f5e8" : "#ffebee",
                      color:
                        stat.changeType === "positive" ? "#2e7d32" : "#c62828",
                      fontWeight: "bold",
                      fontSize: "0.75rem",
                    }}
                  />
