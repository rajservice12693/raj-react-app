    ...
    >
      ...
      >
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          {[
            {
              icon: <EmailIcon sx={{ color: "#fff", fontSize: 24 }} />,
              title: "Email Us",
              content: ["rajservice12693@gmail.com"],
            },
            {
              icon: <PhoneIcon sx={{ color: "#fff", fontSize: 24 }} />,
              title: "Call Us",
              content: ["+91 90603 95477", "+91 7488 252 458"],
            },
            {
              icon: <LocationIcon sx={{ color: "#fff", fontSize: 24 }} />,
              title: "Visit Us",
              content: ["Jamo Bazar", "Dist. Siwan 841413 (Bihar)"],
            },
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  {item.content.map((text, i) => (
                    <Typography
                      ...
                      sx={{
                        color: "#8d6e63",
                        mb: i < item.content.length - 1 ? 1 : 0,
                      }}
                    >
                      {text}
                    </Typography>
